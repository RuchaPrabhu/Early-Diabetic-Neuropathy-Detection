...
// const int ERM_PIN = 2;   // PWM pin connected to ERM motor driver (via transistor or driver IC)
// const int CHANNEL = 0;    // PWM channel (0–15)
// const int FREQ = 2000;    // Frequency in Hz (2 kHz works well for ERM motors)
// const int RESOLUTION = 8; // 8-bit resolution (0–255)

// int duty = 0;             // Start at 0 (motor off)
...
//   ledcAttachPin(ERM_PIN, CHANNEL);

//   Serial.println("PWM increasing by 5 every 500ms...");
// }

// void loop() {
//   // Write current PWM value
//   ledcWrite(CHANNEL, duty);
  
//   // Print status for debugging
//   Serial.printf("Duty = %3d / 255  (%.1f%% power)\n", duty, (duty / 255.0) * 100);

//   // Increase PWM by 5
//   duty += 5;
//   if (duty > 255) duty = 0;  // Reset to 0 after full cycle

//   delay(500);  // Change speed every 0.5 seconds
// }
...
//   float risk = (0.7 * ratio) + (0.3 * (duty / 255.0));

//   if (risk < 0.8) return "LOW";
//   else if (risk < 1.2) return "MEDIUM";
//   else return "HIGH";
// }
